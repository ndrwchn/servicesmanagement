                    ...
                    <v-container grid-list-md>
                        <v-layout wrap>
                            ...
                            <v-flex xs12>
                                ...
                                hint="This is also your loginId." required></v-text-field>
                            </v-flex>
                            <v-flex xs12>
                            ...
                            <v-flex xs12>
                                <v-text-field label="Veryfy Password" v-model="user.verifyPassword"
                                hint="When changing password, please enter twice"
                                persistent-hint
                                :rules="[
                                   () => user.password === user.verifyPassword || 'Password entered do not match'
                                ]"
                                required></v-text-field>
                            </v-flex>
                        </v-layout>
